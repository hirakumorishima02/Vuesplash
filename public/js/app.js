...
// componentsディレクトリに作ったコンポーネントを読み込み
 ...
 //util.jsの INTERNAL_SERVER_ERRORをインポート
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    errorCode: function errorCode() {
      //storeのstateを参照するメソッド
      return this.$store.state.error.code;
    }
  },
  watch: {
    //storeのstateを参照するメソッドを実行して監視
    errorCode: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.loading = true; // AJAXでファイルを送信するためのFormDataAPIを使用している
              ...
              case 5:
                ...
                this.errors = response.data.errors; // バリデーションエラーの場合はエラーメッセージを表示する関係から、値をクリアしたりフォームを閉じない
              ...
              case 10:
                ...
                this.reset(); // inputイベントを発行して自動的にフォームが閉じるようにしている
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            new vue__WEBPACK_IMPORTED_MODULE_1___default.a({
              ...
              //indexで定義したVuexのstate,getters,mutations,actionsをvueインスタンス作成時に読み込む
              components: {
...
window.axios.interceptors.response.use( // 第一引数がレスポンスを受けて成功した時の処理
function (response) {
  return response;
}, // 第二引数は失敗した時の処理
function (error) {
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
 ...
 //util.jsで定義したエラー変数をインポート

var state = {
  user: null,
  apiStatus: null,
  //APIが成功したかどうかを表す。成功の可否でその後の処理を行うかを決める。
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(context) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              context.commit('setApiStatus', null); // apiでルーティング定義したAuthのuser情報を入れる。ログインしていなければnullを返す
            ...
            case 3:
              response = _context4.sent;
              user = response.data || null; // setUserメソッドを使用してuser情報を得る
...
"use strict";
__webpack_require__.r(__webpack_exports__);
//このファイルはコンポーネントをまたいでエラー情報をあつかう error ストアモジュール
var state = {
  code: null
};
var mutations = {
...
function getCookieValue(searchKey) {
  ...
  var val = ''; //; で split してさらに = で split することで
...
__webpack_require__(/*! /home/ec2-user/environment/spa_photo_stock/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/ec2-user/environment/spa_photo_stock/resources/sass/app.scss */"./resources/sass/app.scss");
